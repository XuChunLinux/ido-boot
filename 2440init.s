...
; HISTORY:
; 2013.05.25:XuChun: Modified for S3C2440.
;=========================================
...
ResetHandler
	...
	str	r1,[r0]
								...
								;Led display(GPB5/GPB6/GPB8/GPB10) 
	ldr	r0,=GPBCON
	ldr	r1,=(0x1<<20)+(0x1<<16)+(0x1<<12)+(0x1<<10)+0x1;
	str	r1,[r0]
	ldr	r0,=GPBDAT
	mov	r1,#0x1			 		;all led on, bell ringing
	str	r1,[r0]
	ldr r1,=0xFFFF       		;500ms
1	nop
	subs r1,r1,#1
	bne %B1
	ldr r1,=0x7FE	     		;all led off, disable bell
	str r1,[r0]
    ...
    [ PLL_ON_START
								;Added for confirm clock divide. for S3C2440.
...
1
	...
	str	r1,[r0]
								...
								;Judging from the nor flash start or nand flash start ?
	ldr	r0,=BWSCON
	ldr	r0,[r0]
	ands r0,r0,#6
	bne	CopyNorflashRo
